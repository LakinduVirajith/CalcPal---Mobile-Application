                            ...
                            children: [
                              SizedBox(
                                width: constraints.maxWidth *
                                    0.30, // Set the width to 35% of the screen
  ...
  Widget getNextExerciseScreen(int currentExerciseNumber) {
    switch (currentExerciseNumber) {
      case 1:
        ...
        } while (number1 % 2 != 0); // Ensure number1 is even
        return DivisionLevel2(
          exerciseNumber: 2,
          number1: number1,
          number2: 2, // Number2 is always 2
          backgroundImage: 'assets/images/division_level2_2.png',
          infoMessage: 'Learning Point! Even numbers are divisible by 2.',
        );
      case 2:
        int number1;
        do {
          number1 = Random().nextInt(90) + 10; // Generate a 2-digit number
        } while (number1 % 3 != 0); // Ensure number1 is divisible by 3
        return DivisionLevel2(
          exerciseNumber: 3,
          number1: number1,
          number2: 3, // Number2 is always 3
          backgroundImage: 'assets/images/division_level2_3.png',
          infoMessage:
              'Learning Point! Numbers divisible by 3 have no remainder.',
        );
      case 3:
        int number1 =
            (Random().nextInt(9) + 1) * 10; // Generate multiples of 10
        return DivisionLevel2(
          exerciseNumber: 4,
          number1: number1,
          number2: 10, // Number2 is always 10
          backgroundImage: 'assets/images/division_level2_4.png',
          infoMessage:
              'Learning Point! Multiples of 10 are easy to divide by 10.',
        );
      default:
        int number1 = Random().nextInt(20) + 1; // Number1 between 1 and 20
        return DivisionLevel2(
          exerciseNumber: 1,
          number1: number1,
          number2: 1, // Number2 is always 1
          backgroundImage: 'assets/images/division_level2_1.png',
          infoMessage:
...
class PlaceValueTable extends StatelessWidget {
        ...
        Container(
          ...
          child: Column(
            children: [
              ...
              Row(
                children: [
                  Expanded(child: createSquares(hundreds)),
                  VerticalDivider(
                      color: Colors.black,
                      thickness: 2), // Add a black line between columns
                  Expanded(child: createSquares(tens)),
                  VerticalDivider(
                      color: Colors.black,
                      thickness: 2), // Add a black line between columns
                  Expanded(child: createSquares(ones)),
                ],
              ),
            ],
          ),
  ...
  Widget createSquares(int count) {
    return Wrap(
