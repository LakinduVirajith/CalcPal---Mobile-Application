...
class TableScreenOp extends StatefulWidget {
  @override
  _TableScreenState createState() => _TableScreenState();
}

class _TableScreenState extends State<TableScreenOp> {
  ...
  Widget build(BuildContext context) {
    final List<Map<String, String>> activities = [
      {
        'english': 'Level1 - Addition',
        'localized': AppLocalizations.of(context)!.level1AdditionLbl
      },
      {
        'english': 'Level1 - Subtraction',
        'localized': AppLocalizations.of(context)!.level1SubtractionLbl
      },
      {
        'english': 'Level1 - Multiplication',
        'localized': AppLocalizations.of(context)!.level1MultiplicationLbl
      },
      {
        'english': 'Level1 - Division',
        'localized': AppLocalizations.of(context)!.level1DivisionLbl
      },
      {
        'english': 'Level2 - Addition',
        'localized': AppLocalizations.of(context)!.level2AdditionLbl
      },
      {
        'english': 'Level2 - Subtraction',
        'localized': AppLocalizations.of(context)!.level2SubtractionLbl
      },
      {
        'english': 'Level2 - Multiplication',
        'localized': AppLocalizations.of(context)!.level2MultiplicationLbl
      },
      {
        'english': 'Level2 - Division',
        'localized': AppLocalizations.of(context)!.level2DivisionLbl
      },
    ];
